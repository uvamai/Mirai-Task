    ...
    <div className="glass-toolbar sticky top-3 z-10 space-y-2 rounded-2xl px-4 py-3">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="min-w-0">
          <p className="text-sm font-semibold text-slate-800">
            {activeView ? (
              <>
                Viewing <span className="font-bold text-indigo-700">{activeView.name}</span>
              </>
            ) : (
              surfaceLabel
            )}
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          className={`rounded-xl border border-slate-200 px-3 py-2 text-sm font-semibold hover:bg-white ${
            filtersOpen ? 'bg-white text-indigo-700 border-indigo-300 shadow-sm' : 'bg-white/80 text-slate-700'
          }`}
        >
          Filter options
        </button>
      ...
      {filtersOpen && (
        <div className="flex flex-col gap-2 rounded-xl bg-white/60 p-3 border border-slate-100">
          <div className="flex flex-wrap items-center gap-2">
